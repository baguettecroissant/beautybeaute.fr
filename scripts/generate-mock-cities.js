 ...
 * Run: node scripts/generate-mock-cities.js
 */
...
function generateVillages() {
    ...
    for (let i = 0; i < 50; i++) {
        ...
        do {
            ...
            const root = roots[Math.floor(seededRandom() * roots.length)];
        ...
        const latOffset = (seededRandom() - 0.5) * 0.5;
        const lngOffset = (seededRandom() - 0.5) * 0.5;
        ...
        villages.push({
            ...
            population: Math.floor(seededRandom() * 4500) + 500,
...
// Main execution
const allCities = [...majorCities, ...generateVillages()];
